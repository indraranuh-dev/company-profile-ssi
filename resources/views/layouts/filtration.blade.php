                ...
                <ul>
                    ...
                    <li class="drop-down {{request()->routeIs('product*')? 'active' : ''}}">
                        ...
                        <ul>
                            ...
                            <li class="drop-down">
                                <a href="{{route('product.hvac.index')}}">{{$category->name}}</a>
                                @if (! $category->subcategories->isEmpty())
                                <ul>
                                    @foreach ($category->subCategories as $sub)
                                    <li class="{{(! $sub->suppliers->isEmpty()) ? 'drop-down' : ''}}">
                                        <a href="{{route('product.hvac.subCategory.index',
                                             $sub->slug_name)}}">
                                            {{$sub->name}}
                                        </a>
                                        <ul>
                                            ...
                                            <li>
                                                <a
                                                    href="{{route('product.hvac.vendor.index',[$sub->slug_name, $supplier->slug_name])}}">
                                                    {{$supplier->name}}
                                                </a>
                                            </li>
                                            @endforeach
                            ...
                            <li class="{{(! $category->suppliers->isEmpty()) ? 'drop-down' : ''}}">
                                ...
                                <ul class="py-1">
                                    ...
                                    <li class="m-0">
                                        <a href="{{route('product.filtration.index', $supplier->slug_name)}}">
                                            {{$supplier->name}}
                                        </a>
                                    </li>
                                    @endforeach
