            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('admin.tag.create')}}" class="btn btn-primary">
                        <i class="mdi mdi-plus mr-2"></i>Tag
                    </a>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$tag->name}}</td>
                                <td>{{Converter::convertDate($tag->created_at)}}</td>
                                <td>{{Converter::convertDate($tag->updated_at)}}</td>
                                <td class="text-center">
                                    <a href="{{route('admin.tag.edit', Generator::crypt($tag->id, 'encrypt'))}}"
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-outline-light text-secondary btn-sm"
                                        title="Hapus data"
                                        onclick="deleteConfirmation('{{Generator::crypt($tag->id, 'encrypt')}}')">
...
<x-modal headerBg="danger" modalId="confirm-modal" title="Hapus tag">
    <div class="card-body">
...
<script src="{{Module::asset('admin:ts/tag/app.ts')}}"></script>
@endpush
