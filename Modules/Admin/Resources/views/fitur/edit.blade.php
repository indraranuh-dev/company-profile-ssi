        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Ubah fitur</h4>
                    <a href="{{route('admin.features.index')}}" class="btn btn-primary">
                        <i class="mdi mdi-arrow-left mr-2"></i>Kembali
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.features.update', Generator::crypt($feature->id, 'encrypt'))}}"
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-12">
                                <div class="pic-container"
                                    style="background-image: url({{route('admin.features.icon',$feature->icon)}})">
                                </div>
                                <div class="btn-group">
                                ...
                                <fieldset class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control @error('name'){{'is-invalid'}}@enderror"
                                            name="name" id="name" value="{{$feature->name}}">
                                ...
                                <fieldset class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <select name="category"
                                            ...
                                            <option value="" disabled>Pilih kategori fitur</option>
                                ...
                                <fieldset class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <textarea name="description"
                                            class="form-control
                                            @error('description'){{'is-invalid'}}@enderror">{{$feature->description}}</textarea>
