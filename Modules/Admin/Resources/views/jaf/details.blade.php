        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="btn-group">
                        <a href="{{route('admin.jaf.edit', request()->segment(3))}}" class="btn btn-primary">
                            <i class="mdi mdi-arrow-left mr-2"></i>Kembali
                        </a>
                        <a href="{{route('admin.jaf.createDescription', request()->segment(3))}}" class="btn btn-danger"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="repeater" data-list="description">
                                            ...
                                            <fieldset class="form-group" data-item>
                                                <form
                                                    action="{{route('admin.jaf.updateDescription', G::crypt($detail->id, 'encrypt'))}}"
                                                    method="post">
                                                    @csrf
                                                    @method('put')
                                                    <div class="row">
...
<script>
    async function deleteConfirmation(id) {
        ...
        $("#delete").attr(
            "action",
            `http://127.0.0.1:8000/_admin/japan-air-filter/${id}/deskripsi`
        );
    }
