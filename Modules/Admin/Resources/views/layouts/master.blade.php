...
<body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click"
                    ...
                    <ul class="nav navbar-nav mr-auto float-left">
                        ...
                        <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="#"
                            ...
                            <ul class="mega-dropdown-menu dropdown-menu row">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#"><i class="ft-align-left"></i> Multi level menu</a>
                                                    <ul>
                                                        ...
                                                        <li><a href="#"><i class="fa fa-lemon-o"></i> Second level
                                                                menu</a>
                                                            <ul>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="fa fa-heart-o"></i> Third level</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="fa fa-file-o"></i> Third level</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="fa fa-trash-o"></i> Third level</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="fa fa-clock-o"></i> Third level</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li><a class="dropdown-item" href="#"><i
                                                                    class="fa fa-hdd-o"></i> Second level, third
                                                                link</a></li>
                                                        <li><a class="dropdown-item" href="#"><i
                                                                    class="fa fa-floppy-o"></i> Second level, fourth
                                                                link</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="color-palette-primary.html"><i
                                                            class="ft-camera"></i> Color pallet system</a>
                                                </li>
                                ...
                                <li class="col-md-3">
                                    <h6 class="dropdown-menu-header text-uppercase"><i class="fa fa-list-ul"></i>
                                        Accordion</h6>
                                ...
                                <li class="col-md-4">
                                    <h6 class="dropdown-menu-header text-uppercase mb-1"><i
                                            class="fa fa-envelope-o"></i> Contact Us</h6>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="position-relative has-icon-left">
                                                        ...
                                                        <div class="form-control-position pl-1"><i
                                                                class="fa fa-commenting-o"></i></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                                ...
                                <li><a class="menu-item" href="#">Content Det. Sidebar</a>
                                    <ul class="menu-content">
                                        <li><a class="menu-item"
                                                href="layout-content-detached-left-sidebar.html">Detached left
                                                sidebar</a>
                                        </li>
                                        <li><a class="menu-item"
                ...
                <li class=" nav-item"><a href="#"><i class="ft-zap"></i><span class="menu-title" data-i18n="">Starter
                    ...
                    <ul class="menu-content">
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-1-column.html">1
                                column</a>
                        </li>
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-2-columns.html">2
                                columns</a>
                        </li>
                        <li><a class="menu-item" href="#">Content Det. Sidebar</a>
                            <ul class="menu-content">
                                <li><a class="menu-item"
                                        href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-content-detached-left-sidebar.html">Detached
                                        left sidebar</a>
                                </li>
                                <li><a class="menu-item"
                                        href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-content-detached-left-sticky-sidebar.html">Detached
                                        sticky left sidebar</a>
                                </li>
                                <li><a class="menu-item"
                                        href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-content-detached-right-sidebar.html">Detached
                                        right sidebar</a>
                                </li>
                                <li><a class="menu-item"
                                        href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-content-detached-right-sticky-sidebar.html">Detached
                        ...
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-fixed-navbar.html">Fixed
                                navbar</a>
                        </li>
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-fixed-navigation.html">Fixed
                                navigation</a>
                        </li>
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-fixed-navbar-navigation.html">Fixed
                                navbar &amp; navigation</a>
                        </li>
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-fixed-navbar-footer.html">Fixed
                                navbar &amp; footer</a>
                        </li>
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-fixed.html">Fixed
                                layout</a>
                        </li>
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-boxed.html">Boxed
                                layout</a>
                        </li>
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-static.html">Static
                                layout</a>
                        </li>
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-light.html">Light
                                layout</a>
                        </li>
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-dark.html">Dark
                                layout</a>
                        </li>
                        <li><a class="menu-item"
                                href="../../../starter-kit/ltr/vertical-menu-template-semi-dark/layout-semi-dark.html">Semi
                                dark layout</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item"><a href="email-application.html"><i class="ft-mail"></i><span class="menu-title"
                            data-i18n="">Email Application</span></a>
                </li>
                <li class=" nav-item"><a href="chat-application.html"><i class="ft-message-square"></i><span
                    ...
                    <ul class="menu-content">
                        <li><a class="menu-item" href="#">Echarts</a>
                            <ul class="menu-content">
                                ...
                                <li><a class="menu-item" href="echarts-bar-column-charts.html">Bar &amp; Column
                                        charts</a>
                                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="ft-align-left"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="changelog.html"><i class="ft-file"></i><span class="menu-title"
                            ...
                            class="badge badge badge-pill badge-info float-right">3.0</span></a>
                </li>
                ...
                <li class=" nav-item">
                    <a href="https://pixinvent.com/stack-bootstrap-admin-template/documentation"><i
                            class="ft-folder"></i>
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    ...
                    <h3 class="content-header-title mb-0">HTML 5 Data Export</h3>
                </div>
                    ...
                    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1"><a class="dropdown-item"
                                    href="card-bootstrap.html">Bootstrap Cards</a>
    ...
    <script src="../../../app-assets/vendors/js/tables/datatable/dataTables.buttons.min.js" type="text/javascript">
    </script>
    <script src="../../../app-assets/vendors/js/tables/datatable/buttons.bootstrap4.min.js" type="text/javascript">
    </script>
