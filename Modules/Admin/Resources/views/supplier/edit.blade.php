                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-8 col-md-12 col-sm-12">
                                        <form action="{{route('admin.supplier.update', $supplier->id)}}" method="POST"
                                            class="w-100" id="addform" enctype="multipart/form-data">
                                            @csrf
                                            @method('put')
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <x-input-group icon="truck">
                                                    <input type="text"
                                                        ...
                                                        name="name" placeholder="Nama supplier"
                                                        value="{{$supplier->name}}">
                                                ...
                                                <x-input-group icon="image">
                                                    <div class="custom-file">
                                                        <input type="file"
                                                            ...
                                                            name="image" id="image" value="{{$supplier->images}}">
