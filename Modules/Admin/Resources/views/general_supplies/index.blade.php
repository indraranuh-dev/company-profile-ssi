...
<x-breadcrumb title="Produk">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">General Supplies</li>
    </ol>
</x-breadcrumb>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('admin.gs.create')}}" class="btn btn-primary">
...
<script src="{{Module::asset('admin:ts/gs/app.ts')}}"></script>
@endpush
