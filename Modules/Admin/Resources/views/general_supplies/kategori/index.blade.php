        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('admin.gs-category.create')}}" class="btn btn-primary">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center">
                                        <a href="{{route('admin.gs-category.edit', G::crypt($category->id, 'encrypt'))}}"
...
<script src="{{Module::asset('admin:ts/gs/category/app.ts')}}"></script>
@endpush
