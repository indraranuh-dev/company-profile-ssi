...
<x-breadcrumb title="Kategori">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="{{route('admin.gs-category.index')}}">{{__('Kategori')}}</a>
        </li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('admin.gs-category.index')}}" class="btn btn-primary">
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            <form
                                action="{{route('admin.gs-category.update', Generator::crypt($category->id, 'encrypt'))}}"
                                method="POST">
                                @csrf
                                @method('put')
