    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.product.update', Generator::crypt($product->id, 'encrypt'))}}"
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-12">
                                <div class="pic-container w-75 w-sm-100"
                                    style="background-image: url('{{route('admin.product.image', $product->product_image)}}')">
                                </div>
                                <div class="btn-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3 mb-lg-0">
                                            ...
                                            <select name="supplier"
                                                ...
                                                <option value="" disabled>Pilih supplier (vendor)</option>
                                                @foreach ($suppliers as $supplier)
                                                @if ($product->suppliers[0]->id === $supplier->id)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <select name="subCategory"
                                                ...
                                                @if ($product->subCategories[0]->id === $subCategory->id)
                                ...
                                <fieldset class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <select name="features[]" id="features" multiple
                                            ...
                                            @foreach ($selects['selected'] as $select)
                                            <option value="{{Generator::crypt($select['id'])}}" selected>
                                                {{$select['name']}}
                                            </option>
                                            @endforeach
                                            @foreach ($selects['notSelected'] as $select)
                                            <option value="{{Generator::crypt($select['id'])}}">
                                                {{$select['name']}}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <fieldset class="form-group row">
                                    <div class="col-12">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label spesification-label"
                                                for="">{{$product->spesification}}</label>
                                        </div>
